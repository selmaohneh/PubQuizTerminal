// Server-side quiz validation. Mirrors the validation rules from menu.js
// (the Electron menu controller) so files behave identically in both apps.
...
// Validates a single uploaded quiz file (name + raw text content).
